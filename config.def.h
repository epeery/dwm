...
static const char *filemanager[]  = { "xst ", "-e ranger" };
...
static Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_Return, spawn,          SHCMD("lightterm") },
  ...
  TAGKEYS(                        XK_8,                      7)
  TAGKEYS(                        XK_9,                      8)
  { MODKEY,                       XK_F2,     spawn,          SHCMD("prompt 'Restart DWM?' 'killall dwm'") },
  { MODKEY,                       XK_F4,     spawn,          SHCMD("prompt 'Hibernate?' 'sudo -A systemctl suspend'") },
};
